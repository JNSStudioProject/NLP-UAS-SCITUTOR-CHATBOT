  ...
  <div class="flex h-screen bg-slate-50 overflow-hidden font-sans">
    ...
    <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-slate-50 border-r border-slate-200 flex flex-col transform transition-transform duration-300 ease-in-out lg:static lg:translate-x-0"
      ...
      <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <router-link @click="isMobileMenuOpen = false" to="/admin/model" class="flex items-center px-4 py-3 bg-slate-900 text-white rounded-lg text-sm font-medium transition-colors">
          Model Information
        </router-link>
      </nav>
    </aside>
          ...
          <header class="page-header">
            ...
            <div class="header-actions">
              ...
              <button class="btn btn-primary" @click="fetchModelInfo" :disabled="isLoading">
                <span class="icon" :class="{'spin': isLoading}">
          ...
          <div class="telemetry-grid" v-if="metrics">
            ...
            <section class="metric-category card shadow-sm">
              <div class="category-header">
                <span class="category-icon bg-purple-100 text-purple-600">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h2v2H9V9zm5 0h2v2h-2V9z" />
                  </svg>
                </span>
